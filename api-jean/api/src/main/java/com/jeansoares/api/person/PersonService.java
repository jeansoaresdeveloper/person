...
public class PersonService {
    ...
    private void checkCpf(String cpfDeEntrada, Person pessoaASerSalva) {
        boolean pessoaJaExiste = personRepository.findByCpf(cpfDeEntrada)
                .stream()
                .anyMatch(pessoaEncontrada -> !Objects.equals(pessoaEncontrada , pessoaASerSalva));
        if (pessoaJaExiste) {
            throw new RuntimeException("Já existe uma pessoa cadastrada com o CPF informado.");
        }
    }
